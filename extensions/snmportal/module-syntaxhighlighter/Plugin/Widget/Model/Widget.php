<?php
namespace Snmportal\SyntaxHighlighter\Plugin\Widget\Model;
...
/**
 * Class Widget
 * @package Snmportal\SyntaxHighlighter\Plugin\Widget\Model
 */
class Widget
{
    /**
    ...
    public function beforeGetWidgetDeclaration(
        ...
        if ($type == 'Snmportal\SyntaxHighlighter\Block\Widget\Cm') {
