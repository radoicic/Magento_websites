...
class Collection extends \Magento\Framework\Model\ResourceModel\Db\Collection\AbstractCollection
{
    ...
    {
        $this->_init(
            'Swissup\CheckoutFields\Model\Field\Option',
            'Swissup\CheckoutFields\Model\ResourceModel\Field\Option'
        );
        $this->_optionValueTable = $this->_coreResource->getTableName('swissup_checkoutfields_field_option_value');
    }
