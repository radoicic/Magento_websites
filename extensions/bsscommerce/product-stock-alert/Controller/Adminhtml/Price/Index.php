...
class Index extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        $resultPage->setActiveMenu('Bss_ProductStockAlert::manage_price_alert_subscription');

        //Set the header title of grid
        $resultPage->getConfig()->getTitle()->prepend(__('Manage Price Alert Subscriptions'));
