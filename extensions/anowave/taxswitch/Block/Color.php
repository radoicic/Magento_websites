...
class Color extends \Magento\Config\Block\System\Config\Form\Field
{
	...
	{
		return $this->getLayout()->createBlock('Magento\Config\Block\System\Config\Form\Field')->setTemplate('Anowave_TaxSwitch::color.phtml')->setData(['element' => $element])->toHtml();
	}
}