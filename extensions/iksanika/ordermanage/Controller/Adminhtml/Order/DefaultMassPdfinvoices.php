...
class DefaultMassPdfinvoices extends \Magento\Sales\Controller\Adminhtml\Order
{
    ...
    public function execute()
    {
        ...
        $invoicesCollection = $this->collectionFactory->create()->setOrderFilter(['in' => $orderIds]);
    ...
    {
        return $this->_authorization->isAllowed('Iksanika_Ordermanage::ma_print_invoices');
    }
}