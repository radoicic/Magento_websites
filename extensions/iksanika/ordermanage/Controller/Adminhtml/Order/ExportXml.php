...
use Magento\Sales\Controller\Adminhtml\Product;
use Magento\Framework\Controller\ResultFactory;

class ExportXml extends \Magento\Sales\Controller\Adminhtml\Order
{
    ...
    {
        $content    = $this->_view->getLayout()->addBlock('Iksanika\Ordermanage\Block\Adminhtml\Order\Grid')->getXml();
