...
class DefaultMassCancel extends \Magento\Sales\Controller\Adminhtml\Order
{
    ...
    public function execute()
    {
        ...
        if(is_array($orderIds)) 
        {
            ...
            try {
                ...
                $countNonCancelOrder = count($orderIds) - $countCancelOrder;
...
//                $this->messageManager->addSuccess(__('A total of %1 record(s) have been deleted.', count($orderIds)));
    ...
    {
        return $this->_authorization->isAllowed('Iksanika_Ordermanage::ma_cancel');
    }
