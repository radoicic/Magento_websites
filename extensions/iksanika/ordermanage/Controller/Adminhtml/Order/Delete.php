...
class Delete extends \Magento\Sales\Controller\Adminhtml\Order
{
    ...
    public function execute()
    {
        ...
        if(is_array($orderIds)) 
        {
            ...
            try {
                ...
                $this->messageManager->addSuccess(__('A total of %1 record(s) have been deleted.', $deletedAmount));
    ...
    {
        return $this->_authorization->isAllowed('Iksanika_Ordermanage::ma_delete');
    }
}