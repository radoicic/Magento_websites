...
class DefaultMassPdfshipments extends \Magento\Sales\Controller\Adminhtml\Order
{
    ...
    public function execute()
    {
        ...
        $shipmentsCollection = $this->collectionFactory->create()->setOrderFilter(['in' => $orderIds]);
    ...
    {
        return $this->_authorization->isAllowed('Iksanika_Ordermanage::ma_print_packing_slips');
    }
}