...
//console.log('ITEM: '+item);
            if(multiFields != null) 
            {
                ...
                {
                    if(jQuery('#editData #order'+item+' [name='+multiFields[i]+']').is("textarea"))
                    {
                        itemValue = jQuery('#editData #order'+item+' [name='+multiFields[i]+']').val();
                    }else
                        itemValue = jQuery('#editData #order'+item+' [name='+multiFields[i]+']').val();
//console.debug('#order: '+item+' name='+multiFields[i]);
