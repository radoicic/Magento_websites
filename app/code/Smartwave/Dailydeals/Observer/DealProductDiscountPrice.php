...
class DealProductDiscountPrice implements ObserverInterface
{
    ...
    public function execute(\Magento\Framework\Event\Observer $observer)
    {
        ...
        $gtmDate = $objDate->gmtDate("Y-m-d H:i:s");
        $curdate=strtotime($gtmDate);
        $Todate=strtotime($dailydealcollection->getFirstItem()->getSwDateTo() ?: $gtmDate);
        $fromdate=strtotime($dailydealcollection->getFirstItem()->getSwDateFrom() ?: $gtmDate);
