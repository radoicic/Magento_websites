...
class Item extends \Ecombricks\Common\DataObject\Wrapper
{
     ...
     * 
     * @return \Ecombricks\InventoryCustomerSourceSelection\Wrapper\Model\Sales\ResourceModel\Order\Item\Source
     */
    private function getResourceSourceWrapper(): \Ecombricks\InventoryCustomerSourceSelection\Wrapper\Model\Sales\ResourceModel\Order\Item\Source
    {
        return $this->wrapperFactory->create(
            $this->getObject()->getResource(),
            \Ecombricks\InventoryCustomerSourceSelection\Wrapper\Model\Sales\ResourceModel\Order\Item\Source::class
        );
    }
     ...
     * Get source wrapper
     * 
     * @return \Ecombricks\InventoryCustomerSourceSelection\Wrapper\Model\Sales\Order\Item\Source
     */
    private function getSourceWrapper(): \Ecombricks\InventoryCustomerSourceSelection\Wrapper\Model\Sales\Order\Item\Source
    {
        return $this->wrapperFactory->create(
            $this->getObject(),
            \Ecombricks\InventoryCustomerSourceSelection\Wrapper\Model\Sales\Order\Item\Source::class
        );
    }
