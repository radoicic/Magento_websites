<?php
	 ...
	 * @inheritdoc
	 */
	class RemoveFromCategory implements CategoryLinkRepositoryInterface, CategoryListDeleteBySkuInterface
	{
		/**
		 ...
		 */
		public function removeByIds($categoryId, $productID, $storeId): bool
		{
