<?php
namespace TiDesign\Domainmanager\Model\Domainlist;

use TiDesign\Domainmanager\Model\ResourceModel\Domainlist\CollectionFactory;
...
{
    /**
     * @var \TiDesign\Domainmanager\Model\ResourceModel\Domainlist\Collection
     */
    ...
    public function getData()
    {
        ...
        /** @var $news \TiDesign\Domainmanager\Model\Domainlist */
        ...
        $data = $this->dataPersistor->get('domainmanager_domainlist');
        if (!empty($data)) {
